            ...
            <div className="inline-flex items-center gap-[8px] relative flex-[0_0_auto]">
              <div className="inline-flex items-start relative flex-[0_0_auto]">
                <NavButton
                  ...
                  icon={
                    <Icons.Column className="!relative !w-[20px] !h-[20px]" />
                  }
                  status="default"
                  hasText={false}
                />
                <NavButton
                  className="!flex-[0_0_auto]"
                  icon={
                    <Icons.Grid className="!relative !w-[20px] !h-[20px]" />
                  }
                  status="default"
                  hasText={false}
                />
              ...
              <NavButton
                className="!flex-[0_0_auto]"
                icon={
                  <Icons.Recent className="!relative !w-[20px] !h-[20px]" />
                }
                status="default"
                text="Most recent"
                hasText={true}
            ...
            <>
              <div className="w-full flex self-stretch flex-col items-start gap-[4px] flex-[0_0_auto] relative">
                <div className="inline-flex items-center gap-[8px] px-[8px] py-[4px] h-[24px] rounded-[4px] relative !bg-colors-dividers ">
                  <div className="font-informative-caption w-fit tracking-[var(--informative-caption-letter-spacing)] [font-style:var(--informative-caption-font-style)] text-[length:var(--informative-caption-font-size)] relative font-[number:var(--informative-caption-font-weight)] whitespace-nowrap leading-[var(--informative-caption-line-height)] !mt-[-5.00px] !text-colors-body-primary !tracking-[0] !text-[12px] !mb-[-3.00px] !flex-1 ![font-style:unset] !font-bold ![font-family:'Nunito',Helvetica] !leading-[24px] !w-[unset]">
                    .FIND
                  </div>
                </div>
